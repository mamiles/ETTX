...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="5"  BGCOLOR="E1E1E1" align="center">
  <tr> 
    <td width="100%" align="center" valign="middle"> <uii:layerDialog id="query_subs"> <uii:form action="/querySubs.do"> 
        <!----------------------------------------------------------------------------------------
...
l
    ...
    <td valign="top" align="RIGHT"> <uii:instructions>
                <p> <i18n:message bundleRef="instruction" key="reports.query.p1"/></p>
                <p> <i18n:message bundleRef="instruction" key="reports.query.p2"/></p>
                  </uii:instructions>
    </td>
  </tr>
</table>
