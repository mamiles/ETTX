...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="5"  BGCOLOR="E1E1E1" align="center">
  <tr> 
    <td width="100%" align="center" valign="middle"> <uii:layerDialog id="query_subs"> <uii:form action="/smQuerySubs.do"> 
        <!----------------------------------------------------------------------------------------
...
l
            ...
            <tr bgcolor="silver"> 
              <td colspan="2" bgcolor="silver"> 
                <table cellspacing=3 cellpadding=0 border=0 width="100%">
                  ...
                  <td nowrap> <uii:button property="submit" submitValue="Create" >
				<i18n:message bundleRef="ettx_bundle" key="createSubscriber"/>
			</uii:button>
		  </td>
    ...
    <td valign="top" align="RIGHT"> <uii:instructions>
                <p> <i18n:message bundleRef="instruction" key="subsMgmt.query.p1"/></p>
                <p> <i18n:message bundleRef="instruction" key="subsMgmt.query.p2"/></p>
                  </uii:instructions>
    </td>
  </tr>
</table>
